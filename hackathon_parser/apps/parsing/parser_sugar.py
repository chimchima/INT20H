...
SITES = [
    Site('bigl.ua', 'https://bigl.ua/ua/p775974992-sahar-fasovanonnyj-1kg?click_track_data=.eJwdzrkOgkAUQNF_eTUFa8ahFBFc0AJUgjET1pF1Rtao8d9Fy3ur8wbesmSIe5InoCOkYaRiLAsQhzUPc9r8v6SoClYXAnRsaOMUdIhyWoEAPSvTZs7w4Uh06cZuQqbKb71NPSJaSgXPLNIw0ywNnhD_4MvHyLbwbh3yBpmDiYJAW0Xl6Wxs7VfgkUs-FliRM0N09ndkT_Bz9Cll7XN2dKBfZUUU0e3zBQh5Ous.fWlU35_Ym66AZxnBLN28dlY6EcE'),
    Site('ukr-produkt.com', 'https://www.ukr-produkt.com/product/sahar/'),
    Site('thelavka.com', 'https://thelavka.com/ru/grocery/cereals-and-flour/sahar.html')
]
...
def parse_bigl(html, url):
    ...
    description_paragraphs = div_description.find_all('p')
    description = ''
